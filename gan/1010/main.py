...
if __name__ == '__main__':
    ...
    for i in range(10000):
        ...
        generated_data = G.forward(torch.FloatTensor([0.5])).detach()
        D.strain(generated_data, torch.FloatTensor([0.0]))

        # 训练生成器
        G.strain(D, torch.FloatTensor([0.5]), torch.FloatTensor([1.0]))
